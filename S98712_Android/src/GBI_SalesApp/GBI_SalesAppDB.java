 ...
 * mbs - false 
 */
public final class GBI_SalesAppDB extends com.sybase.persistence.Database
{
    ...
    private static com.sybase.persistence.ConnectionProfile _profile =
        new com.sybase.persistence.ConnectionProfile("gBI_SalesApp1_0");
    ...
    private static class GBI_SalesAppDBHolder {
       final static GBI_SalesAppDB instance = new GBI_SalesAppDB();
    }

    public static GBI_SalesAppDB getInstance() {
       return GBI_SalesAppDBHolder.instance;
    }
    ...
    private static GBI_SalesApp.intrnl.GBI_SalesAppDBMetaData META_DATA = new GBI_SalesApp.intrnl.GBI_SalesAppDBMetaData(DELEGATE);
    /**
    ...
    public static synchronized void initialize()
    {
        ...
        {
            _profile.setProperty("databaseFile", "gBI_SalesApp1_0.ulj");
        ...
        _profile.getSyncProfile().setProperty("packageName","gbi_salesapp:1.0" );
        com.sybase.persistence.ConnectionProfile initProfile = new com.sybase.persistence.ConnectionProfile();
        initProfile.setServerName("vmkrcmar14");
        initProfile.setPortNumber(2480);
        initProfile.setNetworkProtocol("http,https");
        initProfile.setNetworkStreamParams("trusted_certificates=;url_suffix=");
        initProfile.setDomainName("default");
        DELEGATE.setInitialSyncProfile(initProfile);
        DELEGATE.init("gbi_salesapp:1.0", "GBI_SalesApp", META_DATA, _profile, getDSI());
    }

    
    private GBI_SalesAppDB()
    {
        super(getMetaData());
    }
    ...
    {
        return (com.sybase.collections.GenericList<com.sybase.persistence.LogRecord>)(Object)(GBI_SalesApp.LogRecordImpl.findWithQuery(query));
    }
     ...
     */
    public static synchronized GBI_SalesApp.PersonalizationParameters getPersonalizationParameters()
    {
        return (GBI_SalesApp.PersonalizationParameters) DELEGATE.getPersonalizationParameters();
    }
    /**
    ...
    {
        GBI_SalesApp.ChangeLogImpl.deleteChangeLogs();
    }
